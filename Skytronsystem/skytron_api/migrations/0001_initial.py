    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.CharField(default='a16f8e38e2404f4abb37b60582814f26', max_length=32, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drivers', models.ManyToManyField(blank=True, related_name='driver_vehicles', to='skytron_api.driver')),
            ],
        ),
        migrations.CreateModel(
            name='EM_admin',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('holiday_type', models.CharField(choices=[('Public', 'Public'), ('Private', 'Private')], max_length=20, verbose_name='Holiday Type')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='holiday_created_by', to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
                ('vehicles', models.ManyToManyField(related_name='holiday_vehicles', to='skytron_api.devicetag', verbose_name='Vehicle List')),
            ],
        ),
        migrations.CreateModel(
            name='Manufacturer',
